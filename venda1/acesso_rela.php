            ...
            <div class="col-md-4 col-sm-6 col-xs-12">
              <div class="info-box">
                ...
                <div class="info-box-content">
                  ...
                  <a href="../recibo1/fecho.php?dia=<?php echo $_POST['date_1']?>&dia2=<?php echo $_POST['date_2']?>&user=<?php echo $idUser; ?>" target="_blank">FECHO</a> </h2></span>
