...
// Incluir o arquivo de funções do caixa
...
if(isset($_POST['btnsaveorder'])){
    ...
    // Usar a data do caixa aberto em vez da data atual
    $data_caixa = getDataCaixaAberto($idUser, $mysqli);
    $order_date = $data_caixa; // Usar a data do caixa aberto
...
// Obter a data do caixa aberto para exibição
$data_caixa = getDataCaixaAberto($idUser, $mysqli);
            ...
            <form action="" method="post" name="">
                ...
                <div class="box-body">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <label>Data do Caixa Aberto:</label>
                            <div class="input-group">
                                <div class="input-group-addon">
                                    <i class="fa fa-calendar"></i>
                                </div>
                                <input type="text" class="form-control" value="<?php echo $data_formatada; ?>" readonly>
                                <input type="hidden" name="orderdate" value="<?php echo $data_caixa; ?>">
                            </div>
                        </div>
