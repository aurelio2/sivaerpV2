...
<div class="content-wrapper">
  ...
  <section class="content container-fluid">
        <div class="box box-warning">
          ...
          <br> 
          <?php
              $query = "SELECT SUM(emola) as emolatotal FROM tbl_control_payment WHERE data BETWEEN ? AND ?";
             ...
             <!--Pos sum for day-->
             <?php
              $query = "SELECT SUM(pos) as postotal FROM tbl_control_payment WHERE data BETWEEN ? AND ?";
              $date_1 = $_POST['date_1'];
              $date_2 = $_POST['date_2'];
              // Prepare the statement
              if ($stmt = $mysqli->prepare($query)) {
          ...
          $select1=$pdo->prepare("select sum(subtotal) as subtotal from tbl_invoice  where order_date between :fromdate AND :todate");
          ...
          ?>
            <!--Cash sum for day-->
             <?php
             $select2=$pdo->prepare("select sum(cash) as cashtotal from tbl_control_payment where data between :fromdate AND :todate ");
             $select2->bindParam(':fromdate',$_POST['date_1']);  
             $select2->bindParam(':todate',$_POST['date_2']);  
             $select2->execute();
             ...
             ?>
              <!--Mpesa sum for day-->
             <?php
             $select3=$pdo->prepare("select sum(mpesa) as mpesatotal from tbl_control_payment where data between :fromdate AND :todate");
             $select3->bindParam(':fromdate',$_POST['date_1']);
             $select3->bindParam(':todate',$_POST['date_2']);    
             $select3->execute();
            ...
            <?php
             $select21=$pdo->prepare("select sum(valor_recebido-troco) as cash2 from tbl_control_payment where data between :fromdate AND :todate");
             $select21->bindParam(':fromdate',$_POST['date_1']);
             $select21->bindParam(':todate',$_POST['date_2']);  
             $select21->execute();
