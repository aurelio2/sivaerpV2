...
<div class="content-wrapper">
  ...
  <section class="content container-fluid">
   ...
   <div class="box box-warning">
    ...
    <a href="../recibos/lista_codigos.php" target="_blank" class="btn btn-info" role="button"><span class="glyphicon glyphicon-barcode" style="color:#ffffff" data-toggle="tooltip" title="Imprimir Produto" align="right"></span> Imprimir codigos</a>
    <a href="../excel/gerar_planilha_produto.php" target="_blank"><img src="../images/icons8-ms_excel.png" height="50px"></a>
    <br>
    <br>
