      ...
      <div style="overflow-x:auto;" > 
        <table id="producttable" class="table table-striped">
          ...
          <tbody>
            ...
            <?php
            $select=$pdo->prepare("SELECT pid,pname,pcategory,datavalidade FROM tbl_product WHERE datavalidade between NOW() and DATE_ADD(NOW(), INTERVAL 30 DAY) ORDER BY datavalidade");
            $select->execute();
