        ...
        <div class="box box-warning">
          <form  action="" method="post" name="">
            ...
            <div class="box-header with-border">
              <h3 class="box-title"><h3 class="box-title">De : <?php echo $_POST['date_1']?> -- Ate : <?php echo $_POST['date_2']?></h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            ...
            <div class="box-body">                  
             ...
             $select=$pdo->prepare("select sum(subtotal) as total,count(invoice_id) as invoice from tbl_invoice  where order_date between :fromdate AND :todate");
        ...
        <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="info-box">
                  ...
                  <div class="info-box-content">
                    ...
                    <span class="info-box-number"><h2> <a href="../recibos/periodicas_vendas.php?dia=<?php echo $_POST['date_1']?>&dia2=<?php echo $_POST['date_2']?>" target="_blank">Periodico</a> 
