		...
		<table id="salesreporttable" class="table table-striped">
		 ...
		 while($res=mysqli_fetch_array($cons)){
				...
				echo'
                  ...
                  <td>'.number_format($res['total']+$res['t_iva'],2).'</td>
                  <td>'.number_format($res['t_iva'],2).'</td>
             ...
             <a href="diariobar.php"><img src="../images/icons8-circled_left.png" width="40" height="40" title="Voltar para pagina de relatorio"> </a>
      </div>
    </div>
