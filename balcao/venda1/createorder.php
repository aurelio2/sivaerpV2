...
//$cons=mysqli_query($mysqli,"select * from tbl_saidas1 where data='$data'");
...
if(isset($_POST['btnsaveorder'])){
    ...
    $insert=$pdo->prepare("insert into tbl_invoice(mesa,customer_name,order_date,total) values(:mesa,:cust,:orderdate,:total)");
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            Vender  <img src="../../images/icons8-chair.png"> <?php echo $codemesa; ?> 
            <small></small>
        </h1>
        <ol class="breadcrumb">
...
/*}else{
	$insere=$mysqli->prepare("INSERT INTO tbl_saidas1  (tbl_saidas1.idproduto, tbl_saidas1.stock_inicial) 
						SELECT tbl_product.pid, tbl_product.pstock FROM tbl_product");
	if(!$insere->execute()){
		echo "";
	}else{
	$update=mysqli_query($mysqli,"UPDATE tbl_saidas1 SET data='$data' WHERE data = '0000-00-00'");
