  ...
  <div class="wrapper">
    <header class="main-header">
      <a href="mesa.php" class="logo">
       <span class="logo-mini"><b>SIS</b>FA</span>
        <span class="logo-lg"><b>SISFAM</b></span>
      </a>
    ...
    <aside class="main-sidebar">
      ...
      <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
          <li><a href="mesa.php"><img src="../images/icons8-cash_register_45.png"></i> <span>PDV</span></a></li> 
          <li class="treeview">
