...
<div class="content-wrapper">
    ...
    <section class="content container-fluid">
                      ...
                      <table class="table table-bordered" id="producttable"  >
                       ...
                       foreach($row_invoice_details as $item_invoice_details){
                        ...
                        <tr>
                            ...
                            echo '<td><input type="text" class="form-control forma" name="forma[]" value="'.$row_product['pcategory'].'" readonly></td>';
                            
                            echo '<td><input type="text" class="form-control txtivas" name="iva[]" readonly id="txt_txtivas" value="'.$row_product['iva'].'"></td>';
                            ...
                            echo'<td><input type="text" class="form-control totaliva" name="totaliva[]" value="'.$item_invoice_details['t_iva'].'" readonly></td>';

                            //echo'<td><input type="text" class="form-control Subtotal" name="Subtotal[]" value="'.$item_invoice_details['t_sub'].'" readonly></td>';
        ...
        <div align="center">
            ...
            <a href="add_conta.php?id=<?php echo $id;?>&m=<?php echo $codemesa;?>"><button type="button" name="add" value="" class="btn btn-success btn-sm btnadd hidden"><span class="glyphicon glyphicon-plus"> ADICIONAR</span></button></a>
        </div>
...
<script>
    ...
    $(document).ready(function(){
     ...
     $(document).on('click','.btnadd',function(){
        ...
        html+='<td><input type="text" class="form-control Subtotal" name="Subtotal[]" readonly></td>';
