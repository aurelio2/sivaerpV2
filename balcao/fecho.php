      ...
      <!--------------------------
		...
		<table class="grid" style="font-size: 15;" align="center" width="90%">
         ...
         <?php
			...
			$idprod=$row->pid;
			$consul = mysqli_query($mysqli,"select * from tbl_saidas 
		...
		$update=mysqli_query($mysqli,"UPDATE tbl_saidas 
										JOIN tbl_product ON tbl_saidas.idproduto =tbl_product.pid 
										SET tbl_saidas.stock_final = tbl_product.pstock 
										WHERE tbl_saidas.data = '$data'") or die(mysqli_error($mysqli));
