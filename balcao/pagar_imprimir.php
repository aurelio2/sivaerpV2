...
// 3) Write delete query for tbl_invoice_details table data where invoice_id =$id .
    ...
    $update_invoice=$pdo->prepare("update tbl_invoice set mesa=:mesa, customer_name=:cust,order_date=:orderdate,total=:total,discount=:disc,paid=:pago,due=:troco,payment_type=:forma_paga where invoice_id=$id");
        ...
        <div class="box box-warning">
            <form action="" method="post" name="">
                ...
                <div class="box-header with-border">
                    <h3 class="box-title">Pagar a mesa   <img src="../images/icons8-tables.png"> <?php echo $codemesa;?></h3>
                </div>
                <!-- /.box-header -->
                <!-- form start -->
            ...
            <div class="col-md-6">
                ...
                <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" name="txtpaid"  id="txtpaid" required value="<?php echo $pago; ?>">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" name="txtdue" id="txtdue" required value="<?php echo $troco; ?>">
                            </div>
                        </div>
