...
$id=$_GET['id']; 
$select=$pdo->prepare("select * from tbl_requisicao where id=$id");
...
<br><br>
REQUISIÇÃO EXTERNA Nº 0'.$row->id.'
<br><br><br>
</div>

Requisita-se a '.$row->ent_req_name.'<b></b><br>

Para <b><i></i></b><br><br>
Os artigos abaixo indicados:<br>
<p align=right>Requisição interna nº '.$row->id.''.$ano.' 
...
$html.='<td>'.$item->produt_name.'</td>';
$html.='<td align=center>'.$item->quantidad.'</td>';
$html.='</tbody>';
